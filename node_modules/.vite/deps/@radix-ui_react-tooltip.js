...
function createSlot2(ownerName) {
  ...
  const Slot22 = React16.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime8.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React16.isValidElement(newElement) ? React16.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var useReactEffectEvent = React17[" useEffectEvent ".trim().toString()];
var useReactInsertionEffect = React17[" useInsertionEffect ".trim().toString()];
...
function useControllableState({
  ...
  if (true) {
    const isControlledRef = React18.useRef(prop !== void 0);
    React18.useEffect(() => {
